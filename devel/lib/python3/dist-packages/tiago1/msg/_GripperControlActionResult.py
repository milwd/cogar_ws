...
"""autogenerated by genpy from tiago1/GripperControlActionResult.msg. Do not edit."""
import codecs
import sys
...
class GripperControlActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "tiago1/GripperControlActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','tiago1/GripperControlResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GripperControlActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = tiago1.msg.GripperControlResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = tiago1.msg.GripperControlResult()
