...
"""autogenerated by genpy from tiago1/ArmControlFeedback.msg. Do not edit."""
import codecs
import sys
...
class ArmControlFeedback(genpy.Message):
  _md5sum = "d9ca0af36daadfa3b4628ccba7ca6819"
  _type = "tiago1/ArmControlFeedback"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.efforts))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.efforts = s.unpack(str[start:end])
      return self
