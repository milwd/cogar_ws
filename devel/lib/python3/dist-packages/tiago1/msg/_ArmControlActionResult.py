...
"""autogenerated by genpy from tiago1/ArmControlActionResult.msg. Do not edit."""
import codecs
import sys
...
class ArmControlActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "tiago1/ArmControlActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','tiago1/ArmControlResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ArmControlActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = tiago1.msg.ArmControlResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = tiago1.msg.ArmControlResult()
